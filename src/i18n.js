export const translations = {
  ru: {
    ...
    "about.title": "О себе",
    "about.text":
      "Монтирую клипы, YouTube и короткие ролики. Ищу ритм, который держит внимание, и кадр, который говорит сам.",
    "contact.title": "Связь",
  ...
  en: {
    ...
    "about.title": "About",
    "about.text":
      "I edit music videos, YouTube, and short-form. Looking for rhythm that holds attention and frames that speak for themselves.",
